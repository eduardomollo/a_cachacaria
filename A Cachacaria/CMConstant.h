...
extern NSString *const kCMBannerClassKey;
extern NSString *const kCMBannerDayKey;

#pragma mark - Infos Class

extern NSString *const kCMInfosClassKey;
extern NSString *const kCMInfosDayKey;
