...
- (void)configureSendButtonWithStyle:(JSMessageInputViewStyle)style
{
  ...
  //  }
    ...
    NSString *title = NSLocalizedString(@"Enviar", nil);
         ...
         panGestureRecognizer:(UIPanGestureRecognizer *)panGestureRecognizer
{
    ...
    if (self) {
        _style = JSMessageInputViewStyleFlat;
        [self setup];
        [self configureInputBarWithStyle:JSMessageInputViewStyleFlat];
        [self configureSendButtonWithStyle:JSMessageInputViewStyleFlat];
